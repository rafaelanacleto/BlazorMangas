...
public class AuthService : IAuthService
{
    ...
    public async Task<LoginResult> Login(LoginModel loginModel)
    {
        try
        {
            ...
            ((TokenServerAuthenticationStateProvider)_authenticationStateProvider)
                                .MarkUserAsAsAuthenticated(loginModel.Email);
    ...
    public async Task Logout()
    {
        ...
        ((TokenServerAuthenticationStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
